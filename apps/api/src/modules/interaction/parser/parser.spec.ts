...
const cases: EvalCase[] = [
  ...
  { text: '教我做土豆炒蛋', intent: 'KITCHEN_START_TUTORIAL' },
  { text: '怎么做水煮肉片', intent: 'KITCHEN_START_TUTORIAL' },
  { text: '开始做宫保鸡丁', intent: 'KITCHEN_START_TUTORIAL' },
  { text: '这道菜的制作教程是什么', intent: 'KITCHEN_START_TUTORIAL' },

    ...
    <>
      ...
      <main className="container">
        <section className="zone">
          <h2>常用功能</h2>
          <div className="items">
            <Link className="item-card" href="/fridge/wellness">
              <div>
                <div className="name">个人健康</div>
                <div className="qty">档案、体重与分享授权</div>
              </div>
            </Link>
            <Link className="item-card" href="/fridge/foods">
              <div>
                <div className="name">食材百科</div>
                <div className="qty">食材知识、家庭营养结构与自定义食材</div>
              </div>
            </Link>
            <Link className="item-card" href="/fridge/timeline">
              <div>
                <div className="name">家庭动态</div>
                <div className="qty">查看操作记录和撤销变更</div>
              </div>
            </Link>
            <Link className="item-card" href="/fridge/stats">
              <div>
